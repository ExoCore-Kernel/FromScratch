...
clang --target=x86_64-unknown-none-elf -ffreestanding -fno-stack-protector -fno-pic -mno-red-zone -Ikernel/include -c kernel/text_style_runtime.c -o "$BUILD/text_style_runtime.o"
